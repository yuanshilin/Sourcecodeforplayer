...
#define FF_CODEC_PROPERTY_FILM_GRAIN      0x00000004
    ...
    /**
     * Indicates whether the vivid passed from input file  is embedded into the code stream.
     */
    int vivid_embed;

    /**
     * Indicates whether the vivid passed from input file  dump to txt (default vivid_enc_dump.txt)
     */
    int vivid_dump;
} AVCodecContext;

...
static int opt_vivid_metadata_file(void *optctx, const char *opt, const char *arg)
{
    vmetafile = arg;
    return 0;
}
...
const OptionDef options[] = {
    ...
    { "vmeta_url",      HAS_ARG | OPT_EXPERT,                                    { .func_arg = opt_vivid_metadata_file },
        "HDR vivid metadata input txt file", "vividfilename" },
    { "v_ver",      HAS_ARG | OPT_EXPERT  | OPT_INT ,                                    { &vivid_ver},
        "HDR vivid version information", "vividversion" },
    { "vivid_pass",      HAS_ARG | OPT_EXPERT  | OPT_INT ,                                    { &vivid_pass},
        "HDR vivid meta passed from input file", "vivid pass flag" },
    { "vivid_dump",      HAS_ARG | OPT_EXPERT  | OPT_INT ,                                    { &vivid_dump},
        "HDR vivid meta dump when encode", "vivid dump flag" },

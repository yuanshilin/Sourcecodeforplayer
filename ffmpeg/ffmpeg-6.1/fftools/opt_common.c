...
static void print_program_info(int flags, int level)
{
    ...
    av_log(NULL, level, "%s version - HDR Vivid encoder v1.0.1 " FFMPEG_VERSION, program_name);
    if (flags & SHOW_COPYRIGHT)
        av_log(NULL, level, " Copyright (c) %d-%d the FFmpeg developers\nPlease report HDR Vivid encoder related issue(s) to hdr_vivid_support@theuwa.com\nPlease visit http://theuwa.com/tech/faq.html for more information\n",

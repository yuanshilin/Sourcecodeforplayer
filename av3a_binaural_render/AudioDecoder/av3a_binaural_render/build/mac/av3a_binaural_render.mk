...
CXX      := g++
CC       := gcc
CXXFLAGS := -std=c++11 -fPIC -O3 -Wall $(Preprocessors)
CFLAGS   := -fPIC -O3 -Wall $(Preprocessors)
ASFLAGS  := 
AS       := as
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@$(MakeDirCommand) "$(WorkspacePath)/myworkspace/.build-release"
	@echo rebuilt > "$(WorkspacePath)/myworkspace/.build-release/av3a_binaural_render"
...
$(IntermediateDirectory)/av3a_binaural_render_binaural_render$(ObjectSuffix): ../../binaural_render.cpp $(IntermediateDirectory)/av3a_binaural_render_binaural_render$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/binaural_render.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_binaural_render$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_stream_renderer$(ObjectSuffix): ../../stream_renderer.cpp $(IntermediateDirectory)/av3a_binaural_render_stream_renderer$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/stream_renderer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_stream_renderer$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_adm$(ObjectSuffix): ../../adm.cpp $(IntermediateDirectory)/av3a_binaural_render_adm$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/adm.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_adm$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_metadata$(ObjectSuffix): ../../metadata.cpp $(IntermediateDirectory)/av3a_binaural_render_metadata$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/metadata.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_metadata$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_metadata_parser$(ObjectSuffix): ../../metadata_parser.cpp $(IntermediateDirectory)/av3a_binaural_render_metadata_parser$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/metadata_parser.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_metadata_parser$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_xml_parser$(ObjectSuffix): ../../xml_parser.cpp $(IntermediateDirectory)/av3a_binaural_render_xml_parser$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/xml_parser.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_xml_parser$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_avs3_audio$(ObjectSuffix): ../../avs3_audio.cpp $(IntermediateDirectory)/av3a_binaural_render_avs3_audio$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/avs3_audio.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_avs3_audio$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/av3a_binaural_render_interface$(ObjectSuffix): ../../interface.cpp $(IntermediateDirectory)/av3a_binaural_render_interface$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/interface.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/av3a_binaural_render_interface$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/pffft_pffft$(ObjectSuffix): ../../ext/pffft/pffft.c $(IntermediateDirectory)/pffft_pffft$(DependSuffix)
	$(CC) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/pffft/pffft.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/pffft_pffft$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ambisonics_SHEval$(ObjectSuffix): ../../ambisonics/SHEval.cpp $(IntermediateDirectory)/ambisonics_SHEval$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ambisonics/SHEval.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ambisonics_SHEval$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ambisonic_binaural_decoder$(ObjectSuffix): ../../core/ambisonic_binaural_decoder.cpp $(IntermediateDirectory)/core_ambisonic_binaural_decoder$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/ambisonic_binaural_decoder.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ambisonic_binaural_decoder$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ambisonic_encoder$(ObjectSuffix): ../../core/ambisonic_encoder.cpp $(IntermediateDirectory)/core_ambisonic_encoder$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/ambisonic_encoder.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ambisonic_encoder$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ambisonic_rotator$(ObjectSuffix): ../../core/ambisonic_rotator.cpp $(IntermediateDirectory)/core_ambisonic_rotator$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/ambisonic_rotator.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ambisonic_rotator$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_fft_manager$(ObjectSuffix): ../../core/fft_manager.cpp $(IntermediateDirectory)/core_fft_manager$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/fft_manager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_fft_manager$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_listener$(ObjectSuffix): ../../core/listener.cpp $(IntermediateDirectory)/core_listener$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/listener.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_listener$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ramp_processor$(ObjectSuffix): ../../core/ramp_processor.cpp $(IntermediateDirectory)/core_ramp_processor$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/ramp_processor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ramp_processor$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_sound_source$(ObjectSuffix): ../../core/sound_source.cpp $(IntermediateDirectory)/core_sound_source$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/sound_source.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_sound_source$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_spherical_harmonic_hrir$(ObjectSuffix): ../../core/spherical_harmonic_hrir.cpp $(IntermediateDirectory)/core_spherical_harmonic_hrir$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/spherical_harmonic_hrir.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_spherical_harmonic_hrir$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_static_convolver$(ObjectSuffix): ../../core/static_convolver.cpp $(IntermediateDirectory)/core_static_convolver$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/core/static_convolver.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_static_convolver$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/simd_simd_utils$(ObjectSuffix): ../../ext/simd/simd_utils.cc $(IntermediateDirectory)/simd_simd_utils$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/simd/simd_utils.cc" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/simd_simd_utils$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/hrtf_database_hrtf_assets$(ObjectSuffix): ../../ext/hrtf_database/hrtf_assets.cpp $(IntermediateDirectory)/hrtf_database_hrtf_assets$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/hrtf_database/hrtf_assets.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/hrtf_database_hrtf_assets$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/libsamplerate_samplerate$(ObjectSuffix): ../../ext/libsamplerate/samplerate.c $(IntermediateDirectory)/libsamplerate_samplerate$(DependSuffix)
	$(CC) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/libsamplerate/samplerate.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/libsamplerate_samplerate$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/libsamplerate_src_linear$(ObjectSuffix): ../../ext/libsamplerate/src_linear.c $(IntermediateDirectory)/libsamplerate_src_linear$(DependSuffix)
	$(CC) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/libsamplerate/src_linear.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/libsamplerate_src_linear$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/libsamplerate_src_sinc$(ObjectSuffix): ../../ext/libsamplerate/src_sinc.c $(IntermediateDirectory)/libsamplerate_src_sinc$(DependSuffix)
	$(CC) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/libsamplerate/src_sinc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/libsamplerate_src_sinc$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/libsamplerate_src_zoh$(ObjectSuffix): ../../ext/libsamplerate/src_zoh.c $(IntermediateDirectory)/libsamplerate_src_zoh$(DependSuffix)
	$(CC) $(SourceSwitch) "$(WorkspacePath)/AudioDecoder/av3a_binaural_render/ext/libsamplerate/src_zoh.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/libsamplerate_src_zoh$(ObjectSuffix) $(IncludePath)

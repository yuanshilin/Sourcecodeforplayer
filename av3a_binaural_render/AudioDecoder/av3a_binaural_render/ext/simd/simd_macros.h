...
#ifndef RESONANCE_AUDIO_IMPORTED_SIMD_MACROS_H_
#define RESONANCE_AUDIO_IMPORTED_SIMD_MACROS_H_

#if !defined(DISABLE_SIMD) && (defined(__x86_64__) || defined(_M_X64) || defined(i386) || defined(_M_IX86))
// SSE1 is enabled.
#include <xmmintrin.h>
...
#elif !defined(DISABLE_SIMD) && (defined(__aarch64__) || (defined(__arm__) && defined(__ARM_NEON__)))
// ARM NEON is enabled.
#include <arm_neon.h>
...
#endif  // RESONANCE_AUDIO_IMPORTED_SIMD_MACROS_H_

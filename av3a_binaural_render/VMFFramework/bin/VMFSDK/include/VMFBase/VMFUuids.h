#ifndef __VMF_UUIDS_H__
#define __VMF_UUIDS_H__

EXTERN_GUID(CLSID_VMFGraph, 
			0x10c9410f, 0x6ee0, 0x4770, 0xb7, 0xd3, 0xb3, 0x64, 0x77, 0x3c, 0x5a, 0xde);
EXTERN_GUID(CLSID_VMFPlayer, 
			0x91d76357, 0x7882, 0x457e, 0xa7, 0xc2, 0xfa, 0xb6, 0x99, 0x3a, 0x8f, 0x6);
EXTERN_GUID(CLSID_VMFSystemClock, 
			0x80fc4de, 0xb6d0, 0x4783, 0xa4, 0x3, 0x52, 0x63, 0x9a, 0xe0, 0xc8, 0x8c);
// {F205FF6B-47D9-4ae6-908E-DC1E0D7EA912}
EXTERN_GUID(CLSID_VMFMemoryAllocator, 
			0xf205ff6b, 0x47d9, 0x4ae6, 0x90, 0x8e, 0xdc, 0x1e, 0xd, 0x7e, 0xa9, 0x12);

// {6CA1A3D4-39B4-4437-91F4-6690EBBF4A3B}
EXTERN_GUID(CLSID_VMFSeekingPassThru, 
			0x6ca1a3d4, 0x39b4, 0x4437, 0x91, 0xf4, 0x66, 0x90, 0xeb, 0xbf, 0x4a, 0x3b);

#ifndef __WIN_UUIDS_H__
...
OUR_GUID_ENTRY(KSDATAFORMAT_SUBTYPE_PCM,
